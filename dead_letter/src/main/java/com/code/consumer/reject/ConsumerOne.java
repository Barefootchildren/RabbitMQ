package com.code.consumer.reject;
    ...
    public static void main(String[] args) throws Exception {
        ...
        DeliverCallback callback = (consumerTag, delivery) -> {
            ...
            if(message.equals("5")){
                ...
                System.out.println("普通消费者拒绝了消息：" + message);
            }else {
                channel.basicAck(delivery.getEnvelope().getDeliveryTag(), false);
                System.out.println("普通消费者已手动应答消息:"+ message);
            }
        };
        ...
        // 启动消费者，监听正常队列的消息
        channel.basicConsume(NORMAL_QUEUE, false,callback, cancelCallback);
